import { BRAND, APP_REPO_URL } from "../brand";
    ...
    <header className="sticky top-0 z-50 border-b border-white/5 bg-neutral-950/80 backdrop-blur-md">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <a
          ...
          className="flex items-center gap-2 rounded-xl bg-neutral-800 px-3.5 py-2 text-sm font-semibold text-neutral-100 ring-1 ring-white/5 transition hover:bg-neutral-700"
        >
